...
export default function FeaturesSection() {
  ...
  return (
      <section className="py-16 bg-gray-50">
        <div className="max-w-6xl mx-auto px-10 sm:px-36 md:px-14 lg:px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
                <div key={index} className="relative group ">
                  ...
                  {/* Card Content */}
                  <div className="relative h-60 overflow-hidden bg-white border border-gray-300 rounded-2xl p-6 text-center duration-500 group-hover:scale-105 group-hover:shadow-xl transition shadow-emerald-200">
