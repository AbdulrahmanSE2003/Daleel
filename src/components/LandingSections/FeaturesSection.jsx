...
export default function FeaturesSection() {
  const features = [
    {
      icon: <Link className="w-8 h-14 text-emerald-500" />,
    ...
    },
    {
      ...
      title: "Fast & simple",
      description: "Access your links in seconds with our intuitive interface.",
    },
    {
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div key={index} className="relative group">
              ...
              {/* Card Content */}
              <div className="relative bg-white border border-gray-300 rounded-2xl p-6 text-center duration-500 group-hover:scale-105 group-hover:shadow-xl transition shadow-emerald-200">
