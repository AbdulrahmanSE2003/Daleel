...
<div className="bg-white/95 backdrop-blur-md rounded-2xl shadow-xl w-full max-w-md p-6 relative z-50 border border-gray-100/50 animate-slide-in">
  <h2 className="text-2xl font-bold text-gray-900 mb-5 tracking-tight">Edit Link</h2>
  ...
  <div className="flex flex-col gap-5">
    ...
    {/* URL Input */}
    <div>
      <label className="block text-gray-700 text-sm font-medium mb-1.5">URL</label>
      <input
        type="text"
    ...
    <div className="relative">
      <label className="block text-gray-700 text-sm font-medium mb-1.5">Emoji</label>
      <input
        type="text"
    ...
    {/* Tags */}
    <div>
      <label className="block text-gray-700 text-sm font-medium mb-1.5">Tags</label>
